...
LinkLuaModifier("fighter", "modifiers/fighter", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("rogue", "modifiers/rogue", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("mage", "modifiers/mage", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("cleric", "modifiers/cleric", LUA_MODIFIER_MOTION_NONE)

LinkLuaModifier("stats", "modifiers/stats", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("botai", "modifiers/botai", LUA_MODIFIER_MOTION_NONE)
